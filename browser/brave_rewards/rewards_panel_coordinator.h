...
class RewardsPanelCoordinator
 ...
 public:
  ...
  static void RegisterForBrowser(Browser* browser);
  ...
  class Observer : public base::CheckedObserver {
   public:
    ...
    virtual void OnRewardsPanelClosed() {}
  };
  ...
  // Notifies observers that the Rewards panel has been closed. This should only
  // be called by UI objects.
