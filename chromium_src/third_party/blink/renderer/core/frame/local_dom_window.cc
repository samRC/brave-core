...
using brave::MaybeFarbleInteger;
...
int LocalDOMWindow::outerHeight() const {
  ...
  // innerHeight instead:
  return MaybeFarbleInteger(GetExecutionContext(),
                            brave::FarbleKey::WINDOW_INNERHEIGHT, innerHeight(),
...
int LocalDOMWindow::outerWidth() const {
  ...
  // innerWidth instead:
  return MaybeFarbleInteger(GetExecutionContext(),
                            brave::FarbleKey::WINDOW_INNERWIDTH, innerWidth(),
