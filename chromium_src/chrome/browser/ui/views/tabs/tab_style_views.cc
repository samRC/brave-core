...
#define BRAVE_GM2_TAB_STYLE_H_PROTECTED protected:
#define BRAVE_GM2_TAB_STYLE_H_VIRTUAL virtual
#define CreateForTab CreateForTab_ChromiumImpl
#include "src/chrome/browser/ui/views/tabs/tab_style_views.cc"
#undef CreateForTab
#undef BRAVE_GM2_TAB_STYLE_H_VIRTUAL
#undef BRAVE_GM2_TAB_STYLE_H_PROTECTED
...
float BraveGM2TabStyle::GetSeparatorOpacity(bool for_layout,
                                            bool leading) const {
  if (ShouldShowVerticalTabs())
    return 0.f;

  return GM2TabStyle::GetSeparatorOpacity(for_layout, leading);
}
