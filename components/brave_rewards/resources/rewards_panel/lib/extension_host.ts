...
export function createHost (): Host {
  ...
  function addListeners () {
    ...
    // If the Rewards panel is requested while we are still active (likely
    // because the panel is in a cached state), update the panel state and
    // show the UI.
